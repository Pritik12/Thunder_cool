...
import 'package:thumps/Rosecart.dart';
import 'package:thumps/cartsecond2.dart';

class rose extends StatefulWidget {
  const rose({super.key});

  @override
  State<rose> createState() => _redState();
}

class _redState extends State<rose> {
  List<dynamic> _red = [];
  void initState() {
    super.initState();
    _loaddata();
  ...
  Future<void> _loaddata() async {
    String data = await rootBundle.loadString('assets/Rosewine.json');
    setState(() {
