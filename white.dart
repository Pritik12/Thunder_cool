...
import 'package:thumps/add3cart.dart';
import 'package:thumps/cartsecond3.dart';

class white extends StatefulWidget {
  const white({super.key});

  @override
  State<white> createState() => _redState();
}

class _redState extends State<white> {
  List<dynamic> _red = [];
  void initState() {
    super.initState();
    _loaddata();
  ...
  Future<void> _loaddata() async {
    String data = await rootBundle.loadString('assets/white.json');
    setState(() {
