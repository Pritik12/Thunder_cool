...
import 'package:thumps/add4cart.dart';
import 'package:thumps/cartsecond4.dart';

class Grapes extends StatefulWidget {
  const Grapes({super.key});

  @override
  State<Grapes> createState() => _redState();
}

class _redState extends State<Grapes> {
  List<dynamic> _red = [];
  void initState() {
    super.initState();
    _loaddata();
  ...
  Future<void> _loaddata() async {
    String data = await rootBundle.loadString('assets/Grapes.json');
    setState(() {
